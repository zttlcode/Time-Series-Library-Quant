...
def main():
    ...
    ohlcv_paths = [f"D:/github/RobotMeQ_Dataset/QuantData/backTest/bar_USA_{code}_d.csv" for code in stock_codes]
    signal_paths = [f"D:/github/RobotMeQ_Dataset/QuantData/trade_point_backtest_c4_oscillation_boll_nature/USA_{code}_d.csv" for code in stock_codes]

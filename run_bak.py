...
if __name__ == '__main__':
    ...
    parser.add_argument('--root_path', type=str, default='D:/github/RobotMeQ_Dataset/all_six_datasets/exchange_rate/', help='root path of the data file')
    ...
    parser.add_argument('--n_heads', type=int, default=9, help='num of heads')
